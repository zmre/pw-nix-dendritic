  ...
  flake.modules.homeManager.zsh = {
    ...
    programs.zsh = {
      ...
      initContent = lib.mkBefore ''
        ...
        jump_key_places(){
          cd "$(\fd . ~ ~/.config ~/src/sideprojects ~/src/icl ~/src/icl/website.worktree ~/src/personal ~/src/gh ~/Sync/Private/Finances ~/Sync/Private ~/Sync/IronCore\ Docs ~/Sync/IronCore\ Docs/Legal ~/Sync/IronCore\ Docs/Finances ~/Sync/IronCore\ Docs/Design ~/Notes ~/Notes/Calendar ~/Notes/Projects ~/Notes/Areas/Personal ~/Notes/Areas/IronCore ~/notes/Calendar/Meetings --min-depth 1 --max-depth 1 --type d -L -E .Trash -E @Trash | fzf)"
          zle reset-prompt
        }
