  ...
  flake.modules.homeManager.zsh = {
    ...
    programs.zsh = {
      ...
      initContent = lib.mkBefore ''
        ...
        jump_key_places(){
          cd "$(\fd . ~ ~/.config ~/src/sideprojects ~/src/icl ~/src/icl/website.worktree ~/src/personal ~/src/gh ~/Sync/Private/Finances ~/Sync/Private ~/Sync/IronCore\ Docs ~/Sync/IronCore\ Docs/Legal ~/Sync/IronCore\ Docs/Finances ~/Sync/IronCore\ Docs/Design ~/Notes ~/Notes/meetings --min-depth 1 --max-depth 1 --type d -L -E .Trash -E @Trash | fzf)"
          zle reset-prompt
        }
      ...
      shellAliases =
        ...
        // pkgs.lib.optionalAttrs pkgs.stdenv.isDarwin {
          ...
          dwupdate = "pushd ~/src/pw-nix-dendritic ; nix run .#write-flake ; nix flake update ; popd ; dwswitchx ; dwshowupdates";
        ...
        // pkgs.lib.optionalAttrs pkgs.stdenv.isLinux {
          ...
          hmupdate = "pushd ~/src/pw-nix-dendritic ; nix run .#write-flake ; nix flake update ; popd ; hmswitch";
          noupdate = "pushd ~/src/pw-nix-dendritic; nix run .#write-flake ; nix flake update; popd; noswitch";
